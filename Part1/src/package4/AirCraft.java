...
public class AirCraft extends PublicTransportation{
	...
	public String toString() {
		return "This AirCraft has "+ numStops +" stops, and costs $" + ticketPrice + ". The class type is " + result1 + ", and the maintanence type is " + result2 + ".";
	}
	/**
	...
	public boolean equals(AirCraft a1) {
		if(a1.getClass()==this.getClass() && a1.ticketPrice==this.ticketPrice && a1.numStops==this.numStops && a1.result1.equalsIgnoreCase(this.result1) && a1.result2.equalsIgnoreCase(this.result2)) {
			return true;
		}  else return false;
	}
