...
public class CityBus extends PublicTransportation{
	...
	private String lineName, driversName;
	/**
	...
	public String toString() {
		return "This city bus has operation year began on " + beginOperationYear + ". The name of the line is " + lineName + ", and the drivers name is " + driversName + ".";
	}
	/**
	...
	public boolean equals(CityBus c1) {
		if(c1.getClass()==this.getClass() && c1.routeNum==this.routeNum && c1.beginOperationYear==this.beginOperationYear && 
